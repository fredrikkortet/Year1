...
public class ImageLabFrame extends JFrame implements ActionListener
{
    ...
    private void addPictureGenerator(JMenu menu, final PictureGenerator gen)
    {
    ...
    private void addFilter(JMenu menu, final ImageFilter f)
    {
    ...
    private void addScalableFilter(JMenu menu, final ScalableFilter f)
    {
        JMenuItem item = new JMenuItem(f.getMenuName());
        menu.add(item);
        item.addActionListener(new ActionListener()
